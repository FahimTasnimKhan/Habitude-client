...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0F172A] border-t border-gray-800 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8">
        ...
        {/* Quick Links */}
        <div
          className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-12 pt-12 border-t border-gray-800"
          data-aos="fade-up"
          data-aos-delay="500"
        >
          {[
        ...
        {/* Bottom Bar */}
        <div
          className="mt-12 pt-8 pb-6 border-t border-gray-800"
          data-aos="fade-up"
          data-aos-delay="600"
        >
