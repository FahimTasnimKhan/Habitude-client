...
const HabitCard = ({ habit }) => {
  return (
    <div className="group relative bg-gray-900  rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-gray-900/50 transition-all duration-300 border border-gray-800 w-96">
      ...
      <div className="p-6">
        ...
        <Link
          ...
          className="
            block w-full text-center px-4 py-3 rounded-xl font-semibold 
